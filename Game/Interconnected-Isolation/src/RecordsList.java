...
public class RecordsList {
    ...
    public static ArrayList<Record> readRecords() {
        ...
        try {
            Scanner in = new Scanner(new File(System.getProperty("user.home") + "/Desktop/records.txt"));
    ...
    public static void clearRecords() {
        try {
            PrintWriter out = new PrintWriter(new FileWriter(System.getProperty("user.home") + "/Desktop/records.txt"));
            out.close();
        } catch (IOException e) {
        }
    }
